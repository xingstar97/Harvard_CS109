...
The min of temp and atemp should be below 0 Celsius and the max of temp and atemp should be above 30 Celsius in DC. The average of temp and atemp should also be around 15 Celsius. Looks like these two column either have some data issues or are normalized already. Humidity and windspeed seem to have been normalized too. 
...
**2.1** Use pandas' `scatter_matrix` command to visualize the inter-dependencies among all predictors in the dataset. 
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_15_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_18_0.png)
...
f, (ax1, ax2, ax3, ax4) = plt.subplots(4, figsize=(15, 8), sharex=True, sharey=True)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_21_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_24_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_26_0.png)




```python
display(winter.loc[winter['counts'].idxmax()])
```
...
```python
display(fall.loc[fall['counts'].idxmin()])
```
...
## Month distribtion in training data
display(train_data[['month_2', 'month_3', 'month_4', 'month_5', 'month_6', 'month_7', 'month_8', 'month_9', 
                    'month_10', 'month_11', 'month_12']].apply(pd.Series.value_counts))

## Month distribtion in test data
display(test_data[['month_2', 'month_3', 'month_4', 'month_5', 'month_6', 'month_7', 'month_8', 'month_9', 
                   'month_10', 'month_11', 'month_12']].apply(pd.Series.value_counts))
```
...
print("R-squared of OLS for training set: {:.2f}".format(ols.rsquared))
print("R-squared of OLS for testing set: {:.2f}".format(r2_score(y_test, ols.predict(X_test))))
```


    R-squared of OLS for training set: 0.41
    R-squared of OLS for testing set: 0.41
...
<tr>
  <th>Time:</th>                 <td>10:57:18</td>     <th>  Log-Likelihood:    </th> <td> -88306.</td> 
</tr>
<tr>
...
```python
ols.pvalues[ols.pvalues < 0.05].sort_values()
```
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_45_0.png)
...
<tr>
  <th>Time:</th>                 <td>11:03:14</td>     <th>  Log-Likelihood:    </th> <td> -87102.</td> 
</tr>
<tr>
...
print("R-squared of OLS with polynomial terms for training set: {:.3f}".format(ols_poly.rsquared))
print("R-squared of OLS with polynomial terms for testing set: {:.3f}".format(r2_score(
    y_test_poly, ols_poly.predict(X_test_poly))))
```


    R-squared of OLS with polynomial terms for training set: 0.501
    R-squared of OLS with polynomial terms for testing set: 0.497
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_50_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_51_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_52_0.png)
...
print("R-squared of OLS after dropping redundant predictors for training set: {:.3f}".format(ols_drop.rsquared))
print("R-squared of OLS after dropping redundant predictors for testing set: {:.3f}".format(r2_score(
    y_test_drop, ols_drop.predict(X_test_drop))))

ols_drop.summary()
```


    R-squared of OLS after dropping redundant predictors for training set: 0.402
    R-squared of OLS after dropping redundant predictors for testing set: 0.400
...
<tr>
  <th>Time:</th>                 <td>11:07:12</td>     <th>  Log-Likelihood:    </th> <td> -88363.</td> 
</tr>
<tr>
...
display(stats[['k', 'bic', 'features']].head())
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_59_1.png)
...
```
    ...
    Time:                        11:10:34   Log-Likelihood:                -87144.
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_61_0.png)
...
![png](cs109a_hw3_web_files/cs109a_hw3_web_62_0.png)
...
print("R-squared of OLS step-wise model for training set: {:.3f}".format(best_stat.model.rsquared))
print("Adj. R-squared of OLS step-wise model for training set: {:.3f}".format(best_stat.model.rsquared_adj))
print("R-squared of OLS step-wise model for testing set: {:.3f}".format(r2_score(
    y_test_poly, best_stat.model.predict(X_test_step))))
print("---")
print("R-squared of OLS polynomial model for training set: {:.3f}".format(ols_poly.rsquared))
print("Adj. R-squared of OLS polynomial model for training set: {:.3f}".format(ols_poly.rsquared_adj))
print("R-squared of OLS polynomial model for testing set: {:.3f}".format(r2_score(
    y_test_poly, ols_poly.predict(X_test_poly))))
print("---")
print("BIC of OLS step-wise model: {:.0f}".format(best_stat.model.bic))
print("BIC of OLS polynomial model: {:.0f}".format(ols_poly.bic))
```


    R-squared of OLS step-wise model for training set: 0.498
    Adj. R-squared of OLS step-wise model for training set: 0.497
    R-squared of OLS step-wise model for testing set: 0.494
    ---
    R-squared of OLS polynomial model for training set: 0.501
    Adj. R-squared of OLS polynomial model for training set: 0.500
    R-squared of OLS polynomial model for testing set: 0.497
    ---
    BIC of OLS step-wise model: 174412
    BIC of OLS polynomial model: 174529
